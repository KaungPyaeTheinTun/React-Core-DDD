      ...
      <AnimatePresence mode="popLayout">
        {showForm && !editingId && (
          <CreateForm
            ...
            roleForm={roleForm as unknown as Record<string, unknown>}
            setRoleForm={setRoleForm as unknown as (value: Record<string, unknown>) => void}
      ...
      <AnimatePresence>
        {deleteModalOpen && (
          <DeleteModal
            ...
            itemName={(targetItem as { name?: string })?.name || ""}
            title="Remove Role"
          />
        )}
      </AnimatePresence>
