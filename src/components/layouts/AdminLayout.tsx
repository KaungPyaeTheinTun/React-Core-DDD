  ...
  return (
    <div className="min-h-screen max-w-full overflow-x-hidden bg-white text-zinc-900 selection:bg-black selection:text-white">
      ...
      <div className="flex h-[calc(100vh-4rem)]">
        <Sidebar collapsed={sidebarCollapsed} onToggle={() => setSidebarCollapsed((prev: boolean) => !prev)} />

        <main className="flex-1 overflow-y-auto animate-in fade-in duration-300 pb-16 md:pb-0">
          <Outlet />
        </main>
      </div>
