...
export default function Header({ currentUser, onLogout, sidebarCollapsed, onToggleSidebar }: HeaderProps) {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const roles = useSelector(selectRoles);

  const panelLabel = (roles as string[]).some((r: string) => r.toLowerCase() === "editor")
    ? "Editor Panel"
    : "Admin Panel";
